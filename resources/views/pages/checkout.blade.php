...
<style>
    ...
    /* Style cho input guest checkout */
    .form-input-guest {
    ...
    .form-input-guest:focus {
        border-color: #34A4E0 !important;
        box-shadow: 0 0 0 3px rgba(52, 164, 224, 0.1) !important;
        outline: none !important;
    }
    ...
    <div class="container checkout-section">
        ...
        <form action="{{ route('dathang') }}" method="POST" id="checkout">
            ...
            <div class="checkout-card">
                ...
                {{-- Nếu chưa đăng nhập (Guest Checkout) --}}
                @if ($showusers->isEmpty())
                    <div class="alert alert-info mb-4" style="background: #e0f2fe; border: 1px solid #bae6fd; border-left: 4px solid #0284c7; color: #0c4a6e; padding: 15px; border-radius: 8px;">
                        <i class="fas fa-info-circle"></i> Bạn đang mua hàng không cần đăng nhập. Vui lòng nhập thông tin nhận hàng bên dưới.
                    </div>

                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="form-label fw-semibold"><i class="fas fa-user"></i> Họ tên <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-input-guest" id="guest_hoten" name="display_hoten" placeholder="Ví dụ: Nguyễn Văn A" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="form-label fw-semibold"><i class="fas fa-envelope"></i> Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control form-input-guest" id="guest_email" name="display_email" placeholder="Ví dụ: nguyenvana@email.com" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="form-label fw-semibold"><i class="fas fa-phone"></i> Số điện thoại <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-input-guest" id="guest_sdt" name="display_sdt" placeholder="Ví dụ: 0987654321" pattern="^0\d{9}$" minlength="10" maxlength="10" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="form-label fw-semibold"><i class="fas fa-map-marker-alt"></i> Tỉnh / Thành phố <span class="text-danger">*</span></label>
                                <select class="form-control form-select form-input-guest" id="guest_thanh_pho" required>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label class="form-label fw-semibold"><i class="fas fa-map-marker-alt"></i> Địa chỉ nhận hàng chi tiết <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-input-guest" id="guest_diachi" name="display_diachigiaohang" placeholder="Ví dụ: 123 Đường Lý Thường Kiệt" required>
                            </div>
                        </div>
                    </div>
                @else
                    {{-- Nếu đã đăng nhập, hiển thị thông tin user (autofill) --}}
